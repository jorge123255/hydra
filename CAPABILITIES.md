# CAPABILITIES.md — What I Can Do Right Now

- ✅ **Chat & Q&A**: Answer questions, have conversations, explain concepts
- ✅ **Code Generation & Review**: Write, review, refactor, and debug code via OpenCode
- ✅ **Image Understanding**: Analyze photos and screenshots sent in chat
- ✅ **Ollama Cloud Models**: Access to nemotron, devstral, deepseek and 14+ models
- ✅ **ChatGPT Subagents**: Fan-out parallel tasks to GPT-4o pool
- ✅ **Mac Desktop Control**: Click, type, take screenshots, run AppleScript, control apps
- ✅ **Persistent Memory**: Remember notes, goals, facts across sessions
- ✅ **Task Scheduling**: Run tasks on cron or ISO date schedule
...
_Last updated: 2026-03-17T17:56 UTC_